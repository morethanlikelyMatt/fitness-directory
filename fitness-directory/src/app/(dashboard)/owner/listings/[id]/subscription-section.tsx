      ...
      {isPremium && isActive ? (
        <div className="mt-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="mt-4 rounded-lg border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50:bg-zinc-800"
          >
              ...
              <button
                ...
                className={`rounded-md px-4 py-2 text-sm font-medium transition-colors ${
                  selectedInterval === "monthly"
                    ...
                    : "text-zinc-600 hover:text-zinc-900:text-white"
                }`}
              >
                Monthly
              </button>
